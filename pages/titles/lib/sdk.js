  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
          ...
          for (let c = 0; c < cast.length; c++) {
            ...
            cast_block.style.height = `calc(${
              document.getElementsByClassName('cast')[0].clientWidth / cast.length
            }"px" - 5%)`
...
const AddBrowseSearchCards = ({ cards, itemsPerLine }) => {
  ...
  let scale =
    (100 * ((carousel_width - btn_width) / itemsPerLine - card_margin * 2)) / initial_width
...
const Next = (elem) => {
  ...
  first_elem.remove()
  carousel.insertBefore(first_elem, carousel.children[carousel.children.length - 1])
